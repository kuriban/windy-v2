...
window.W = Object.assign(window.W || {}, {
  ...
  function(e) {
    ...
    function i(n, o) {
      ...
      const s = "default" in a ? a.default : a;
    ...
    e.require = function(e, n) {
      ...
      for (const e in t) t[e].wasLoaded || i(t[e])
    }
  ...
  _reset: function() {
    if (this._map && this._canvas) {
      const e = this._map.containerPointToLayerPoint([0, 0]);
  ...
  _animateZoom: function(e) {
    ...
    const t = this._map.getZoomScale(e.zoom),
  ...
  _updateTransform: function(e, t) {
    if (this._map && this._canvas && this._center) {
      const n = this._map.getZoomScale(t, this._zoom),
  ...
  const t = {
    ...
    instance: function() {
      ...
      const n = this.extend.apply(this, e);
      return typeof n._init == "function" && n._init.call(n), n
    }
  };
  e.default = t
  ...
  let n = function() {
      let e;
      return (e = window.W.lib) === null || void 0 === e ? void 0 : e.verbose
    },
    i = 0,
    o = [];
  ...
  const a = t.extend({
    _init: function() {
      if (this.latestId = 1, this._eventedCache = {}, n()) {
        const e = ["red", "darkcyan", "green", "orange", "darkblue", "violet", "darkgreen", "blue", "brown", "blueviolet", "coral", "darkcyan", "midnightblue"];
    ...
    off: function(e, t, n) {
      if (typeof e == "number")
        for (const i in this._eventedCache) {
          const o = this._eventedCache[i];
          if (o) {
            for (let r = o.length; r--;) o[r].id === e && o.splice(r, 1);
            o.length === 0 && delete this._eventedCache[i]
          }
        } else {
        const a = this._eventedCache[e];
        if (a) {
          for (let s = a.length; s--;) a[s].callback !== t || n && n !== a[s].context || a.splice(s, 1);
          this._eventedCache && a.length === 0 && delete this._eventedCache[e]
        }
      }
    }
  });
  ...
  let s = i.joinPath,
    ...
    y = function(e) {
      const t = document.head.querySelector('meta[name="token"]'),
        i = {
          token: t && t.content,
  ...
  const S = function(e) {
    ...
    _ = function(e, t, n) {
      if (void 0 === n && (n = {}), typeof n.qs == "object") {
        const i = c(n.qs);
        i && (t = l(t, i))
      }
      let r, s = v.test(t) || g.test(t) || n.withCredentials,
        u = t;
      if (void 0 === n.cache && e === "get" && (n.cache = !0), n.cache) {
        const h = d.get(t);
        if (h) {
          ...
          w.onreadystatechange = function() {
            ...
            if (w.readyState === 4)
              if (n.parseHeaders && w.getAllResponseHeaders().split(/\n/).forEach((function(e) {
                ...
                const s = S(a);
                e(s)
              } else w.status === 0 && o.emit("noConnection", "http"), n.cache && d.remove(u), t(w)
          }
        })),
        O = null;
      e !== "post" && e !== "put" || (w.setRequestHeader("Content-type", "application/json; charset=utf-8"), O = JSON.stringify(n.data));
      try {
        w.send(O)
      } catch (e) {
  ...
  try {
    if (window.localStorage.setItem("test", "bar"), window.localStorage.getItem("test") !== "bar") throw new Error("Comparsion failed");
    window.localStorage.removeItem("test"), t.isAvbl = !0
  } catch (e) {
    0
  }
  const o = t.isAvbl ? t : i;
  e.default = o
  ...
  const o = function() {
    ...
    s = function(e, n) {
      return void 0 === n && (n = {}), e === null ? a() : (r(), t.remove("failedSubscriptionPayment"), document.body.classList.add(`subs-${  e}`)), t.set("subscription", e), n.reloadUserToken && i.emit("userReloadInfo"), e
    },
    l = function() {
  ...
  let l = !0,
    c = function(e) {
      let t = `dp=${  e  }&dl=https://ai4.windy.com/&${  a}`;
  ...
  var o = "bcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789a",
      ...
      if (typeof e == "object" && e !== {}) {
        const o = function(e) {
          for (let t = arguments, n = 1; n < arguments.length; n++) {
            var o = t[n] != null ? t[n] : {},
              r = Object.keys(o);
            typeof Object.getOwnPropertySymbols == "function" && (r = r.concat(Object.getOwnPropertySymbols(o).filter((function(e) {
    ...
    d = function(e) {
      return typeof e.dir == "number" && typeof e.wind == "number" && e.dir <= 360 && e.wind > 0
    },
    u = function(e, t, n) {
  ...
  e.$ = function(e, t) {
    ...
    return e && typeof e == "object" && "lat" in e && "lon" in e && !isNaN(+e.lat) && !isNaN(+e.lon) || !1
    ...
    const t = Math.floor(100 * (e.lat + 90)),
    ...
    return new Promise((function(n, i) {
      ...
      o.type = "text/javascript", o.async = !0, o.onload = function() {
        ...
        i(e)
      }, document.head.appendChild(o), t && typeof t == "function" && t(o), o.src = e
    }))
  ...
  e.getCitytile = function(e, t) {
    let i, a, s, l, c = `https://ims-s.windy.com/forecast/citytile/v1.3/${  e  }/${  t}`,
      d = (i = r[e]) === null || void 0 === i || (a = i.calendar) === null || void 0 === a ? void 0 : a.numOfHours;
    return c = n.addQs(c, `step=${  !1 === ((s = r[e]) === null || void 0 === s || (l = s.minifest) === null || void 0 === l ? void 0 : l.premium) || o.hasAny() ? 1 : 3}`), d && (c = n.addQs(c, `hours=${  d}`)),
      function(e, t) {
        const i = r[t];
        if (!(i == null ? void 0 : i.refTime)) return e;
        const o = i.getUpdateTimes.call(i).refTime;
  ...
  e.DD2DMS = function(e, t) {
    ...
    setTimeout((function() {
      return function(e, t) {
        var n = Date.now(),
          o = n + 4e3,
          r = function() {
            const a = Math.floor(i.smoothstep(n, o, Date.now()) * e);
    ...
    return n.get("hourFormat") === "12h" ? r : a
    ...
    if (n < 0 && (t = !0), n = Math.abs(n), e && e.translate) {
      if (n === 0) return o.NOW;
      if (n < 60) {
        const r = t ? o.METAR_MIN_LATER : o.METAR_MIN_AGO;
        return i.template(r, {
          DURATION: n
        })
      }
      ...
      if (n < 1440) {
        const c = t ? o.METAR_HOURS_LATER : o.METAR_HOURS_AGO;
        return i.template(c, {
          DURATION: Math.floor(n / 60)
        })
      }
      const d = t ? o.METARS_DAYS_LATER : o.METARS_DAYS_AGO;
      return i.template(d, {
  ...
  const o = i.t,
    r = function e(t) {
      ...
      for (let n = e.add(this.startOfTimeline, 12), i = 0; i < this.calendarHours / 24; i++) {
        const o = e.add(this.startOfTimeline, i, "days").getTime(),
      ...
      for (let d = 1; d < this.paths.length; d++) this.interTimestamps.push(this.timestamps[d - 1] + Math.floor((this.timestamps[d] - this.timestamps[d - 1]) / 2))
    };
  r.prototype.initProperties = function() {
    ...
    const e = this.startOfTimeline.getUTCHours() % 3;
    e && (this.startOfTimeline = r.add(this.startOfTimeline, 3 - e, "hours"));
    for (let t = 0; t < this.numOfHours; t += 3) {
      const n = r.add(this.startOfTimeline, t, "hours");
      this.paths.push(r.date2path(n)), this.timestamps.push(n.getTime())
    }
  }, r.prototype.prepareTimesFromMinifest = function(e) {
    return e && typeof e == "object" && e.ref && e.dst ? (this.refTime = e.ref.replace(/(\d+)-(\d+)-(\d+)T(\d+):.*/, "$1$2$3$4"), this.refTimeTxt = e.ref, this.updateTxt = e.update, this.refTimeTs = new Date(e.ref).getTime(), this.updateTs = new Date(e.update).getTime(), !0) : (window.wError("Calendar", "Invalid format of minifest"), !1)
    ...
    return e.dst.forEach((function(e) {
      for (let n = e[1]; n <= e[2]; n += e[0]) {
        const o = t.refTimeTs + n * i;
    ...
    const t = e.split(/(.{4})(.{2})(.{2})(.{2})/g).filter(Boolean).map((function(e) {
    ...
    return o.setTime(e.getTime() + (i === "days" ? 24 : 1) * t * n.tsHour), o
  ...
  a.prototype.onMetricChanged = function(e) {
    ...
    let n;
    return void 0 === e ? "" : this.convertNumber(e) + (t || this.separator) + (((n = this.conv[this.metric]) === null || void 0 === n ? void 0 : n.label) || this.metric)
  }, a.prototype.na = function() {
    let e;
    return ((e = this.conv[this.metric]) === null || void 0 === e ? void 0 : e.na) || "-"
    ...
    t.set(this.key, e), this.cohesion && Object.keys(this.cohesion).forEach((function(i) {
      let o, r, a = (o = n.cohesion) === null || void 0 === o || (r = o[i]) === null || void 0 === r ? void 0 : r[e];
      a && t.set(n._createKey(i), a)
    }))
  }, a.prototype.cycleMetric = function() {
    let e = this.description.indexOf(this.metric) + 1;
  ...
  const s = function(e) {
    ...
    d = function(e) {
      ...
      return e && (t.__proto__ = e), t.prototype = Object.create(e && e.prototype), t.prototype.constructor = t, t.prototype.convertNumber = function(e) {
        ...
        const n = this;
        e.getColor();
        const i = [1, 3, 4, 5, 6, 7, 8].map((function(t) {
  ...
  const i = n.extend({
    ...
    gradYuva: function(e, t, n, i) {
      const o = this.lerpArray(e, t, n);
      if (i) {
        const r = this.vec2size(e[1], e[2]),
          a = this.vec2size(t[1], t[2]);
        if (r > .05 && a > .05) {
          const s = this.vec2size(o[1], o[2]);
          if (s > .01) {
            const l = (r * (1 - n) + a * n) / s;
            o[1] *= l, o[2] *= l
          }
    ...
    makePremultiplied: function(e) {
      for (let t = e[3] / 255, n = 0; n < 3; n++) e[n] = Math.max(0, Math.min(t * e[n], 255));
      return e
    },
    createGradientArray: function(e, t, n) {
      void 0 === e && (e = !0), void 0 === t && (t = !1), void 0 === n && (n = 1);
      let i, o, r, a, s, l = this.steps + 1,
  ...
  const h = d.Window,
    ...
    f = l.extend({
      ...
      moveTs: function(e, n) {
        if (void 0 === n && (n = !1), n) {
          let i = this.acTimes.indexOf(s.get("acTime"));
      ...
      loadAndProcessMinifest: function(e) {
        ...
        return void 0 === e && (e = !1), this.loadMinifest().then((function(n) {
          ...
          const n = (e == null ? void 0 : e.responseText) || `Sorry, but we are unable to download data for the ${  t.modelName  }. Please check the <a href="https://community.windy.com/category/24/system-status" target="_blank">system status</a> to make sure there is no any outage, or try again later.`;
          throw new h({
            ident: "message",
            className: "bg-error",
            html: `<span>${  n  }</span>`
      ...
      loadInfo: function(e) {
        ...
        const o = `${this.server || n.server  }/im/v3.0/${  this.directory  }/${  this.infoVersion  }/info.json`;
        return r.get(o, {
          ttl: 48 * t.tsHour
        }).catch((function() {
      ...
      loadAndProcessInfo: function() {
        return this.requiresInfoJson ? this.loadInfo().then((function(e) {
          ...
          Object.keys(t && t.param || {}).forEach((function(e) {
            if (t.param[e].color) {
              const n = Object.keys(o).find((function(t) {
          ...
          const e = "Cannot get info.json from im server.";
          throw new h({
            ident: "message",
            className: "bg-error",
            html: `<span>${  e  }</span>`
      ...
      pointIsInBounds: function(e) {
        ...
        for (let t = +e.lat, n = +e.lon, i = 0; i < this.bounds.length; i++) {
  ...
  s.prototype.getColor = function() {
    ...
    const n = t[e] ? t[e].calendar : t.ecmwf.calendar;
    ...
    let a, s, l, c, d, u = this,
      h = this.product || e.product,
      p = t[h],
      f = { ...e, layer: this.ident,
        ...
        level: (a = u.levels || p.levels, s = e.level, l = e.hasMoreLevels, c = e.overlay, d = s, l || (d = "surface"), a && !a.includes(d) && (d = a[0]), d === "100m" && c !== "wind" && (d = "surface"), d),
        fullPath: "", ...this.renderParams};
    return (p.ident === r ? Promise.resolve() : this.getCalendar(p.ident).then((function(e) {
      ...
      const e = u.isAccu ? "{server}/im/v3.0/{directory}/{refTime}/{acTime}/wm_grid_257/<z>/<x>/<y>/{filename}-surface.{fileSuffix}" : u.pathGenerator || p.pathGenerator;
  ...
  let i, o = n.t,
    ...
    h = new c({
      ...
      conv: {
        ...
        bft: {
          conversion: function(e) {
            for (let t = [.3, 1.5, 3.3, 5.5, 8, 10.8, 13.9, 17.2, 20.7, 24.5, 28.4, 32.6], n = 0; n < t.length; n++)
              if (e < t[n]) return n;
            return 12
          },
          precision: 0
    ...
    Z = {
      ...
      awp: new c({
        ...
        renderLegend: function(e, t) {
          let n;
          e.getColor(), t.style.background = "", t.dataset.overlay = "awp", t.innerHTML = ((n = this.labels.map((function(t, n) {
            return n > 0 ? `<span style="text-align:center;background:${  e.colorDark(n - 1, 50)  };">${  o[t]  }</span>` : ""
          }))) !== null && void 0 !== n ? n : []).join("")
        }
      }),
      awd_0_40: Q,
      awd_0_100: X
  ...
  const l = (0, i.$)('meta[name="model"]');
  l && l.content && o.globalProducts.includes(l.content) && l.content !== "ecmwf" && t.set("product", l.content);
  const c = {},
    d = {},
    u = Object.keys(r);
  ...
  e.betterProducts = p, e.dedupeIcon = h, e.getIconModel = function(e, t) {
    return e === "icon" && t.includes("iconEu") ? "iconEu" : e === "iconWaves" && t.includes("iconEuWaves") ? "iconEuWaves" : e === "iconEuWaves" && t.includes("iconWaves") ? "iconWaves" : e === "iconEu" && t.includes("icon") ? "icon" : null
  }, e.getPointProducts = function(e) {
    const t = p(e, !0).filter((function(e) {
      return !/Waves/.test(e)
    }));
    ...
    const a = t.get("prefferedProduct");
    if (i.length === 2 && i.includes("cams")) {
      const s = t.get("mapCoords");
      return r.camsEu.pointIsInBounds(s) ? "camsEu" : "cams"
    }
    if (i.includes(n)) return n;
    if (i.includes("iconD2") && a === "iconEu") return "iconD2";
    if (i.includes("iconEu") && a === "icon") return "iconEu";
    if (i.includes(a)) return a;
    if (i.includes("ecmwfWaves") && a === "ecmwf") return "ecmwfWaves";
    if (i.includes("gfsWaves") && a === "gfs") return "gfsWaves";
    if (i.includes("iconEuWaves") && a === "icon") return "iconEuWaves";
    if (i.includes("iconWaves") && a === "icon") return "iconWaves";
    if (i.length > 1) {
      const l = t.get("mapCoords"),
  ...
  const h = u.get,
    ...
    q = i.instance({
      ...
      loadInfoJson: function(e) {
        const t = (new Date).toISOString().replace(/.*T(\d+):(\d+).*/, "$1$2"),
      ...
      moveTs: function(e) {
        let t = this.calendar.timestamps,
        ...
        void 0 === o && (o = t[i]);
        const r = f(t.indexOf(o) + (e ? 1 : -1), 0, i);
  ...
  let t, n, i, o, r, a = window.navigator.userAgent,
  ...
  h !== "auto" && t.isValidLang(h) && (p = h), p && (t.isValidLang(p) ? u = p : (p = p.replace(/-\S+$/, "")) !== (u = t.isValidLang(p) ? p : "en") && (l = p));
  const m = function(e, t) {
    ...
    w = function(e) {
      g.forEach((function(t) {
        for (let n = e.querySelectorAll(`[data-${  t  }]`), i = 0, o = n.length; i < o; i++) {
          const r = n[i],
            a = f(r.dataset[t]);
          switch (t) {
            case "t":
            ...
            case "tooltipsrc":
              ...
              break;
            case "afterbegin":
              r.firstChild && r.firstChild.nodeType == 3 && r.removeChild(r.firstChild), r.insertAdjacentHTML(t, a);
              break;
            case "beforeend":
              r.lastChild && r.lastChild.nodeType == 3 && r.removeChild(r.lastChild), r.insertAdjacentHTML(t, a)
          }
        }
      }))
    };
  ...
  function y(e) {
    const t = Object.keys(c).filter((function(e) {
      return c[e].loaded
    })).map((function(t) {
      return v(t, e)
    }));
  ...
  const b = function() {
    w(document.body), y(u), o.on("lang", (function(e) {
      e !== "auto" && e !== o.get("usedLang") && y(e)
    }))
  };
  document.readyState !== "loading" ? b() : document.addEventListener("DOMContentLoaded", b), e.getFile = m, e.loadLangFile = v, e.missingLang = l, e.t = d, e.translateDocument = w
})), W.define("store", ["dataSpecifications", "storage", "Evented"], (function(e, t, n, i) {
  const o = {},
    r = function(e, t) {
      return typeof e.allowed == "function" ? e.allowed(t) : Array.isArray(e.def) ? Array.isArray(t) && t.every((function(t) {
    ...
    s = function(e) {
      ...
      return a.save && n.isAvbl ? (i = n.get(`settings_${  e}`)) === null ? i = a.def : r(a, i) || (window.wError("store", `Attempt to get invalid value from localStorage: ${  e}`), i = a.def) : i = a.def, o[e] = i, i
    },
    l = function(e) {
      return t[e].def
    },
  ...
  function p(e, t, i, r) {
    if (r === null ? delete o[e] : o[e] = r, t.save && !i.doNotStore && n.isAvbl) {
      const a = i.update || Date.now();
  ...
  const i = [!0, !1],
    ...
    r = function(e) {
      return void 0 !== e && typeof e == "object"
    },
    a = function(e) {
      return n.isValidLatLonObj(e) || e == null
    },
    s = function(e) {
      return void 0 !== e && typeof e == "string"
    },
    l = function(e) {
      return e === null || s(e)
    },
    ...
    u = {
      ...
      particles: {
        ...
        allowed: function(e) {
          ...
          for (const n in this.def)
            if (typeof(t = e[n]) != "number" || t > 2 || t < 0) return !1;
          return !0
        }
      },
      startUp: {
      ...
      startUpLastPosition: {
        ...
        allowed: function(e) {
          return e !== null && n.isValidLatLonObj(e) && Number.isInteger(e.zoom) && (e.source === "maps" || e.source === "globe")
        },
        save: !0,
        nativeSync: !0
      },
  ...
  const c = function() {
    ...
    d = function(e) {
      void 0 === e && (e = {
        enableHighAccuracy: t.platform === "android",
        timeout: 7e3
      });
      const n = function(e, t) {
        ...
        i = function(e, n) {
          const i = {
            errorId: n.message === "location disabled" && t.platform === "android" ? "LOC_1" : "LOC_2",
            category: "location"
          };
          s.add(i), e(c())
        },
  ...
  e.getFallbackName = u, e.getGPSlocation = d, e.getHomeLocation = function(e) {
    const t = o.get("startUp"),
      i = Date.now(),
      a = o.get("homeLocation");
    if (t === "last") {
      const s = o.get("startUpLastPosition");
      if (s) return void e(function(e) {
        for (let t = arguments, n = 1; n < arguments.length; n++) {
          var i = t[n] != null ? t[n] : {},
            o = Object.keys(i);
          typeof Object.getOwnPropertySymbols == "function" && (o = o.concat(Object.getOwnPropertySymbols(i).filter((function(e) {
    ...
    if (t === "location" && a) e(a);
      ...
      const u = c();
      u.source === "fallback" || i - u.ts > 12 * n.tsHour ? r.once("newLocation", e) : e(u)
    } else {
      const h = o.get("gpsLocation");
      h && h.source === "gps" && i - h.ts < 9e5 ? e(h) : d().then(e)
    }
  }, e.getMyLatestPos = c
  ...
  function s(e) {
    ...
    t.open("HEAD", "https://node.windy.com/node/connection", !0), t.onreadystatechange = function() {
      t.readyState === 4 && e(t.status >= 200 && t.status < 400)
    };
    try {
      t.send(null)
    } catch (t) {
  ...
  e.deactivateCurrentDevice = function() {
    ...
    if (a.get("user")) {
      ...
      }), n.target === "mobile" && e && (t.registrationHash = e, t.notifPluginVersion = "Capacitor" in window ? 2 : 1);
      const l = i.get("lastSentDevice");
  ...
  const a = t.getNativePlugin("PushNotifications"),
    ...
    l = o.instance({
      ...
      watchChanges: function() {
        const e = this;
        this.canRecieveNotif = !0, this.emit("canRecieveNotif"), this.eventSource = n.createEventSource("/notif/v1/notifications/stream"), this.eventSource !== null && this.eventSource.addEventListener("notifications-update", (function(t) {
      ...
      loadNotificationList: function(e, t) {
        ...
        return e === 1 && (o.markAsViewed = !0), n.get("/notif/v1/notifications", {
          cache: !1,
          qs: o
        }).then((function(e) {
          const t = e.data;
  ...
  function c(e) {
    switch (e.category) {
      case "location":
        e.errorId === "LOC_1" ? function(e) {
          if (!o) return;
          o.isGpsEnabled().then((function(t) {
            t && t.status === "authorized" && l(e.errorId)
          }), (function(e) {
  ...
  const o = i.loadLangFile,
    r = function(e) {
      let t, n, i, o;
      this.initProperties(), this.dependencies = (t = e.dependencies) !== null && void 0 !== t ? t : this.dependencies, this.exclusive = e.exclusive, this.ident = e.ident, this.langFiles = e.langFiles, this.location = e.location, this.close = (n = e.close) !== null && void 0 !== n ? n : this.close, this.paramsChanged = (i = e.paramsChanged) !== null && void 0 !== i ? i : this.paramsChanged, this.redraw = (o = e.redraw) !== null && void 0 !== o ? o : this.redraw
    };
  r.prototype.getAssetsLocation = function() {
    return this.location ? this.location.substr(0, 4) === "http" ? this.location : n.joinPath("https://www.windy.com/js", this.location) : `${t.assets  }/plugins/${  this.ident  }.js`
  }, r.prototype.load = function() {
    let e, t = this;
    if (this.isLoaded) return Promise.resolve(!0);
    if (this.loading) return this.promise || Promise.resolve(!0);
    this.loading = !0;
    const i = this.dependencies.map((function(t) {
      let n;
      return (e = (n = W.plugins[t]) === null || void 0 === n ? void 0 : n.load()) !== null && void 0 !== e ? e : Promise.reject()
    }));
  ...
  const l = r.$,
    ...
    u = function(e) {
      function t(t) {
        ...
        e.call(this, t), this.unmountOnClose = (n = t.unmountOnClose) !== null && void 0 !== n ? n : this.unmountOnClose, this.hasURL = (i = t.hasURL) !== null && void 0 !== i ? i : this.hasURL, this.title = t.title, this.addMobileSlider = (o = t.addMobileSlider) !== null && void 0 !== o ? o : this.addMobileSlider, this.closeOnSwipeDown = (r = t.closeOnSwipeDown) !== null && void 0 !== r ? r : this.closeOnSwipeDown, this.noCloseOnBackButton = t.noCloseOnBackButton, this.hook = t.hook, this.interpolator = t.interpolator, this.close = (a = t.close) !== null && void 0 !== a ? a : this.close, this.onurl = (s = t.onurl) !== null && void 0 !== s ? s : this.onurl, this.onopen = (l = t.onopen) !== null && void 0 !== l ? l : this.onopen, this.onclose = (c = t.onclose) !== null && void 0 !== c ? c : this.onclose, this.onclosed = (d = t.onclosed) !== null && void 0 !== d ? d : this.onclosed, this.window = this.createWindow(t)
      }
      ...
      return t.prototype.open = function(e, t) {
        ...
        let e;
        this.node && (this.unmountOnClose ? ((e = this.node.parentNode) === null || void 0 === e || e.removeChild(this.node), this.isMounted = !1) : this.node.style.display = "none")
      }, t.prototype.prepareMount = function() {
        const e = `@plugins/${  this.ident}`,
          t = W.modules[e];
        ...
        const e = this.prepareMount() || {},
          t = e.module,
          n = e.id;
        t && n && (t.callback && typeof t.callback == "function" && W.require(n, this), this.isMounted = !0, this.onmounted())
  ...
  const i = n.$,
    o = function(e) {
      function t(t) {
        let n;
        e.call(this, t), this.beforeOpen = (n = t.beforeOpen) !== null && void 0 !== n ? n : this.beforeOpen
      }
      return e && (t.__proto__ = e), t.prototype = Object.create(e && e.prototype), t.prototype.constructor = t, t.prototype.beforeOpen = function(e, t) {}, t.prototype.open = function(t, n) {
        ...
        let e;
        this.node && (this.unmountOnClose && this.svelteApp ? (this.svelteApp.$destroy(), (e = this.node.parentNode) === null || void 0 === e || e.removeChild(this.node), this.isMounted = !1, this.svelteApp = null) : this.node.style.display = "none")
      }, t
    }(t.WindowPlugin);
  e.SveltePlugin = o
})), W.define("plugins", ["rootScope", "Plugin", "TagPlugin", "AutoOpenPlugin", "SveltePlugin", "urls", "http", "broadcast"], (function(e, t, n, i, o, r, a, s, l) {
  const c = r.SveltePlugin,
    d = o.AutoOpenPlugin,
    u = i.TagPlugin,
    h = n.Plugin,
    p = {
      ...
      "webcams-detail": new c({
        ...
        beforeOpen: function(e) {
          if (!this.isLoaded && !this.loading) {
            const t = typeof e == "object" ? e.webcamId || e.id : e;
  ...
  function a(e, t) {
    const i = r(e) && n[e];
    i && i.exclusive !== "neverClose" && i.close.call(i, t)
  }
  ...
  function l(e) {
    ...
    const c = e === "rplanner" && t.isMobileOrTablet ? "distance" : e !== "distance" || t.isMobileOrTablet ? e : "rplanner",
      d = r(c) && n[c];
    d && (d.exclusive && d.exclusive !== "neverClose" && (d.exclusive === "all" ? o.each(n, (function(t, n) {
      t.isOpen && n !== e && a(n)
    })) : d.exclusive === "rhpane" || d.exclusive === "lhpane" ? (["detail", "rplanner", "station", "webcams-detail"].forEach((function(e) {
      const t = n[e];
      t.close.call(t)
  ...
  const a = o.extend(n, i, {
    ...
    click: function(e) {
      if (!this.dragging) {
        this.addAnimation();
        const n = t.bound(e.pageX - this.offset - this.borderOffset, 0, this.maxWidth);
    ...
    updateGhost: function(e) {
      const n = t.bound(e.clientX - this.offset - this.borderOffset, 0, this.maxWidth);
  ...
  const o = t.isFunction,
    r = t.$,
    a = i.extend({
      _init: function() {
        this.initValue = n.get(this.bindStore), n.on(this.bindStore, this.set, this), typeof this.render == "function" && n.on("usedLang", this.render, this), i._init.call(this)
      },
      unmount: function() {
        n.off(this.bindStore, this.set, this), typeof this.render == "function" && n.off("usedLang", this.render, this)
      },
      set: function(e) {
        const t = r(".selected", this.el),
          n = this.getEl(e);
        t && t.classList.remove("selected"), n && n.classList.add("selected")
      },
      click: function(e, t) {
        if (e === "set") n.set(this.bindStore, t);
        else {
          const i = this[e];
          o(i) && i.call(this, t)
        }
  ...
  const o = function(e, t) {
    ...
    r = t.extend({
      ...
      onevent: function(e) {
        ...
        let n, i = e.target,
          o = Boolean(i.nodeName === "A" && ((t = i.href) === null || void 0 === t ? void 0 : t.length));
  ...
  const l = i.t,
    c = a.extend({
      ...
      unfold: function(e) {
        for (let n = t[e], i = n && n.parentMenu || e, o = this.el.querySelectorAll("[data-parent]"), a = 0; a < o.length; a++) {
          const s = o[a];
          r.toggleClass(s, s.dataset.parent === i, "menu-unfold")
        }
      },
      _render: function() {
        let e, i = n.get("favOverlays"),
          a = n.get("expertMode"),
          c = n.get("usedLang"),
          d = (s.seoLang(c), {}),
          u = {},
        ...
        if (a || r.each(t, (function(e, n) {
          ...
          const f = [].concat(o.overlays);
          Object.keys(u).forEach((function(e) {
            if (!f.includes(e)) {
              const t = f.findIndex((function(t) {
        ...
        let m = e.map((function(e) {
          ...
          const m = s && (i.includes(s) || u[s]);
          s ? s in d ? d[s]++ : d[s] = 1 : h++;
          const v = n.getName.call(n);
  ...
  const o = t.debounce,
    r = i.extend({
      ...
      resize: function() {
        const e = this.resizableEl.getBoundingClientRect();
  ...
  const n = t.extend({
    ...
    touchMove: function(e) {
      ...
      const t = this.x - this.xThrottled,
        n = this.y - this.yThrottled;
      if (!(Math.sqrt(t * t + n * n) < this.threshold)) {
        this.xThrottled = this.x, this.yThrottled = this.y;
        let i = null;
        Math.abs(n / t) < .2 ? i = t > 0 ? "right" : "left" : Math.abs(t / n) < .2 && (i = n > 0 ? "down" : "up"), i !== null && (this.direction === null || this.direction === i ? this.direction = i : this.isSwipeValid = !1)
      }
    },
    touchEnd: function(e) {
      if (this.direction !== null && this.isSwipeValid) {
        const t = this.x - this.xStart,
  ...
  const d = i.t,
    ...
    p = a.extend({
      ...
      forEach: function(e) {
        for (let t = this.el.querySelectorAll(".webcam"), n = 0; n < t.length; n++) e(t[n], n)
      },
      setWH: function(e, t) {
  ...
  const i = n.translateDocument,
    o = t.$,
    r = function(e) {
      let t, n, i, o, r, a, s, l, c, d, u, h;
      this.initProperties(), this.unmountOnClose = (t = e.unmountOnClose) !== null && void 0 !== t ? t : this.unmountOnClose, this.attachPoint = (n = e.attachPoint) !== null && void 0 !== n ? n : this.attachPoint, this.bodyClass = (i = e.bodyClass) !== null && void 0 !== i ? i : this.bodyClass, this.className = e.className, this.closeOnClick = (o = e.closeOnClick) !== null && void 0 !== o ? o : this.closeOnClick, this.displayBlock = (r = e.displayBlock) !== null && void 0 !== r ? r : this.displayBlock, this.html = e.html, this.domEl = (a = e.domEl) !== null && void 0 !== a ? a : this.domEl, this.htmlID = e.htmlID, this.ident = e.ident, this.keyboard = (s = e.keyboard) !== null && void 0 !== s ? s : this.keyboard, this.replaceMountingPoint = (l = e.replaceMountingPoint) !== null && void 0 !== l ? l : this.replaceMountingPoint, this.timeout = (c = e.timeout) !== null && void 0 !== c ? c : this.timeout, this.onclose = (d = e.onclose) !== null && void 0 !== d ? d : this.onclose, this.onclosed = (u = e.onclosed) !== null && void 0 !== u ? u : this.onclosed, this.onopen = (h = e.onopen) !== null && void 0 !== h ? h : this.onopen
    };
  r.prototype.close = function(e) {
    let t, n = this;
    this.isOpen && (this.isOpen = !1, document.body.classList.remove(this.bodyClass), (t = this.node) === null || void 0 === t || t.classList.remove("open"), Promise.resolve(this.onclose()).then((function() {
      n.closingTimer = setTimeout((function() {
        n.onclosed(), n.unmount()
      }), 500)
    })), this.removeHooks(), !this.closeOnClick && (e == null ? void 0 : e.stopPropagation) && e.stopPropagation())
  }, r.prototype.open = function() {
    const e = this;
    ...
    return document.body.classList.add(this.bodyClass), this.displayBlock && (this.node.style.display = "block"), this.addHooks(), setTimeout((function() {
      let t;
      (t = e.node) === null || void 0 === t || t.classList.add("open")
    ...
    const t = this.domEl || o(this.attachPoint);
    ...
    let e, t;
    this.refs = {};
    for (let n = (t = (e = this.node) === null || void 0 === e ? void 0 : e.querySelectorAll("[data-ref]")) !== null && void 0 !== t ? t : [], i = 0, o = n.length; i < o; i++) {
      const r = n[i];
    ...
    let e;
    this.unmountOnClose && this.node && ((e = this.node.parentNode) === null || void 0 === e || e.removeChild(this.node), this.node = void 0)
  ...
  const i = n.$,
    o = t.extend({
      ...
      fill: function() {
        const e = this.getEl(this.selected);
  ...
  const o = n.extend(t, {
    _init: function() {
      this.initValue = i.get(this.bindStore), i.on(this.bindStore, this.set, this), typeof this.render == "function" && i.on("usedLang", this.render, this), n._init.call(this)
    },
    set: function(e) {
  ...
  const o = i.t,
    r = t.extend({
      ...
      createText: function(e) {
        const t = Math.floor(this.numberOfHours * this.left / (24 * this.progressWidth)),
          i = this.calendar.days[t],
          r = i ? `${  o[this.zuluMode ? i.display : i.displayLong]  }${i.day && ` ${  i.day}`  } - ` : "";
        if (this.zuluMode) {
          const a = this.calendar.start + 36e5 * (.5 + this.numberOfHours * this.left / this.progressWidth);
      ...
      createGhostText: function(e) {
        const t = Math.floor(e / this.progressWidth * this.numberOfHours) % 24;
  ...
  const r = i.$,
    a = t.extend({
      ...
      _init: function() {
        const e = this;
        t._init.call(this);
        const n = this.scrollEl || r(".plugin-content", this.pluginEl);
        if (n) {
          let i = !1;
      ...
      initCloseOnSwipeDown: function(e) {
        ...
        this.swipeHandler = o.instance({
          ...
          onswipe: function(e) {
            t && e === "down" && n.emit("rqstClose", i.pluginName)
          }
        })
      },
      startDrag: function(e) {
        t.startDrag.call(this, e);
        const n = window.getComputedStyle(this.pluginEl).transform,
          i = /matrix\(.+,\s*(\S+)\)/.exec(n);
  ...
  u.instance({
    ...
    render: function() {
      const e = i.get("availAcTimes");
      this.el.innerHTML = e.map((function(e) {
        const t = /next(\d+)(h|d)/.exec(e);
        return `<div data-do="set,${  e  }">${  r.template(t[2] === "h" ? m.ACC_NEXT_HOURS : m.ACC_NEXT_DAYS, {
          num: t[1]
        })  }</div>`
    ...
    click: function(e) {
      switch (e) {
        case "openapp":
          window.location.href = a.platform === "ios" ? "https://apps.apple.com/app/apple-store/id1161387262?pt=118417623&ct=webapp&mt=8" : "https://play.google.com/store/apps/details?id=com.windyty.android&utm_source=menu&utm_medium=windy&utm_campaign=openAppLink&utm_content=openAppLink";
          break;
        case "title":
          s.emit("back2home");
          break;
    ...
    render: function() {
      const e = i.get("overlay"),
        ...
        r = i.get("level"),
        s = [];
      n.hasMoreLevels && r !== "surface" && s.push(a.levelsData[r][0].replace(/Pa/, "")), !/ecmwf/.test(o.ident) && o.modelName && o.modelName.length && s.push(o.modelName);
      const c = `<span class="uiyellow"\n                ${  s.length ? `data-notes="${  s.join(" ")  }"` : ""  }\n                >${  n.getName.call(n)  }</span>`;
  ...
  n.isMobile && a.instance({
    ...
    render: function() {
      ...
      if (e) {
        ...
        })), i = o.get("hourFormat") === "12h", a = "<b></b>", s = "", c = 1; c < 24; c += 3) {
          const d = i ? (c + 11) % 12 + 1 : c;
          s += `<li>${  t.pad(d)  }</li>`
        }
    ...
    onscrollend: function() {
      this.scrolling = !1;
      const e = t.bound(this.timestamp, this.calendar.start, this.calendar.end);
      o.set("timestamp", e, {
        UIident: this.UIident
    ...
    set: function(e, t) {
      if (this.calendar && t !== this.UIident) {
        this.timestamp = e;
        const n = (e - this.calendar.start) / this.tsPx;
  ...
  const i = n.extend({
    ...
    open: function(e) {
      ...
      for (var i = [], o = 0; o < this.dependencies.length; o++) {
        const r = this.dependencies[o],
          a = t[r];
        if (a && !a.isLoaded) {
          const s = a.open.call(a, e);
          i.push(s)
        }
      }
      ...
      getTiles: function(e) {
        ...
        if (Math.floor(i) === i) {
          ...
          s.forEach((function(t) {
            let i, r, a = o.whichTile(t, e),
              s = a && ((r = (i = n).processTile) === null || void 0 === r ? void 0 : r.call(i, a, e));
            if (s && !_[s.url]) {
              _[s.url] = 1;
              const l = n.loader.loadTile(s);
              E.push(l)
            }
  ...
  const i = t.extend({
    ...
    getVelocityFun: function(e) {
      const t = this.zoom2speed[e.zoom],
    ...
    getAmount: function(e) {
      const t = e.speed2pixel < 1 ? 1 + 1.5 * (1 - e.speed2pixel) : 1,
        n = this.getAmountMultiplier(),
        i = 1 / (this.multiplier.constant * (n * this.multiplier.pow)**(e.zoom - this.multiplier.zoom));
    ...
    getBlendingAlpha: function(e) {
      const t = .9 * (this.configurable && this.config.blending != 1 ? this.config.blending : 1) * (e.speed2pixel < .8 ? 1 + (.8 - e.speed2pixel) / 7 : 1);
    ...
    c = L.GridLayer.extend({
      ...
      redrawLayer: function() {
        ...
        if (s > 11) this.redrawFinished();
          ...
          const l = this.sortTilesFromCenterOut(a);
      ...
      redrawTile: function(e) {
        ...
        const i = n.whichTile(e.coords, this.latestParams),
          o = this.syncCounter;
        l.loadTile(i).then((function(n) {
          t.renderTile.call(t, 2, e.el, o, i, n)
        })).catch((function(t) {
          s(e.el, t == null ? void 0 : t.url)
        })).then((function() {
      ...
      createTile: function(e, t) {
        ...
        const o = n.whichTile(e, this.latestParams),
  ...
  d.prototype.load = function() {
    ...
    return this.status = "loading", this.promise = new Promise((function(t, n) {
      ...
      r.crossOrigin = "Anonymous", r.onload = function() {
        ...
        const n = c.getImageData(0, 0, r.width, r.height);
        e.data = n.data, e.status = "loaded";
        const i = function(e, t) {
            let n, i, o, r, a = new ArrayBuffer(28),
              s = new Uint8Array(a),
  ...
  let h, p, f = {
    ...
    m = !1,
    v = (p = window.W.lib) === null || void 0 === p ? void 0 : p.initAuth;
  h = function(e) {
    return r(e, `api=${  v}`)
  };
  var g = function() {
    ...
    w = function() {
      v ? ((0, window.W.require)("http").post("https://api.windy.com/api4/refresh", {
        ...
        (e == null ? void 0 : e.status) === 401 && (console.error(`Failed to verify Windy API token: ${  e.response}`, e), v = void 0, h = function() {
          return ""
        }, g())
      })), setTimeout(w, 3e4)) : g()
    };
  ...
  const h = u.getImageData(0, 0, 256, 256);
  e.createCombinedFillFun = function(e, t, n, i) {
    ...
    return function(e, t, n, c) {
      const h = i(n, c);
      if (h === 0) return l(e, t, n);
      if (h === 4) return d(e, t, c);
    ...
    e !== null && (a = e[t], s = e[t + 1], l = e[t + 2], c = e[t + 3]);
    const d = Math.max(a, s, l, c);
  ...
  var a = r.instance({
    ...
    u = t.instance({
      ...
      onopen: function(e) {
        const t = W.require("@plugins/isolines");
    ...
    h = t.instance({
      ...
      onopen: function(e) {
        const t = W.require("@plugins/particles");
    ...
    p = t.instance({
      ...
      onopen: function(e) {
        const t = W.require("@plugins/gl-particles");
  ...
  o.on("paramsChanged", (function(e) {
    c = e, p();
    const o = i[e.overlay].layers.slice(),
      r = [];
    e.isolines !== "off" && o.unshift(`${e.isolines  }Isolines`);
    const a = o.map((function(t) {
      const i = n[t];
  ...
  const i = function(e, i, o, r, a) {
    Date.now();
    let s, l = e.latestParams,
      c = l.isMultiColor;
    i |= 0;
    o.width != 256 && (o.width = o.height = 256);
    let d, u = a.data,
      h = o.getContext("2d"),
      p = t.imgData.data;
    l.fileSuffix === "png" ? l.PNGtransparency && (d = t.testPNGtransparency) : l.JPGtransparency && (d = t.testJPGtransparency);
    let f, m, v, g, w = !1,
      y = 0 | r.trans,
      b = 0 | Math.log2(y),
      T = 0 | Math.log2(y * y),
      ...
      oe = c && ((s = J.getColor2) === null || void 0 === s ? void 0 : s.call(J)),
      re = c && oe ? t.createCombinedFillFun(p, ne, oe, J.getAmountByColor) : null,
      ae = ie;
    for (g = 0; g < 256; g += i)
      for (N = g - ((R = g >> b) << b), v = 0; v < 256; v += i) I = v - ((O = v >> b) << b), x !== O && (L = 2056 + O + C + (((D = R + M) << 8) + D) << 2, void 0 !== d && (w = d(u, L)), !0 === $ && (L += 2), k = u[L], U = u[L + 4], F = u[L + 1028], H = u[L + 1032], !0 === K && (G = u[L + 1], z = u[L + 5], B = u[L + 1029], j = u[L + 1033]), x = O), w ? ae(v, g, NaN) : (Q = te(A !== null ? k * A[P = I + (N << b) << 2] + U * A[P + 1] + F * A[P + 2] + H * A[P + 3] >> T : k * (V = (1 - (f = I / y)) * (1 - (m = N / y))) + U * (Y = f * (1 - m)) + F * (q = m * (1 - f)) + H * (X = f * m)), !0 === K && (Z = ee(A !== null ? G * A[P] + z * A[P + 1] + B * A[P + 2] + j * A[P + 3] >> T : G * V + z * Y + B * q + j * X)), c && re ? re(v, g, Q, Z) : ie(v, g, K ? Math.sqrt(Q * Q + Z * Z) : Q));
  ...
  let t, n = WebGLRenderingContext,
    i = (t = new ArrayBuffer(2), new DataView(t).setInt16(0, 256, !0), new Int16Array(t)[0] === 256),
    o = function(e) {
      return e.charAt(0) === "a"
    },
    r = function(e) {
      return e.charAt(0) === "u" || e.charAt(0) === "s"
    },
    a = function e(t, n) {
  ...
  a.prototype.reset = function() {
    ...
    const i = this.gl();
    if (!i) return null;
    const o = i.createShader(t ? i.VERTEX_SHADER : i.FRAGMENT_SHADER);
    if (o && (this.keepRefsShaders && this.shaders.push(o), i.shaderSource(o, e), i.compileShader(o), !i.getShaderParameter(o, i.COMPILE_STATUS))) {
      const r = i.getShaderInfoLog(o) || "getShaderInfoLog is null",
        a = new Error(r);
    ...
    const h = this.createShader(u + e, !0, i),
    ...
    if (a.attachShader(c, h), a.attachShader(c, p), a.linkProgram(c), !a.getProgramParameter(c, a.LINK_STATUS)) {
      const f = a.getProgramInfoLog(c) || "getProgramInfoLog is null";
    ...
    const m = a.getProgramParameter(c, a.ACTIVE_ATTRIBUTES);
    for (s = 0; s < m; s++) {
      const v = a.getActiveAttrib(c, s);
      if (v) {
        const g = v.name;
    ...
    const w = a.getProgramParameter(c, a.ACTIVE_UNIFORMS);
    for (s = 0; s < w; s++) {
      const y = a.getActiveUniform(c, s);
      if (y) {
        const b = y.name;
    ...
    let t;
    a.removeFromArray(e, this.programs), (t = this.gl()) === null || void 0 === t || t.deleteProgram(e)
    ...
    if (r = r || n.RGBA, e._width = i, e._height = o, e._format = r, s) {
      if (s.bindTexture(n.TEXTURE_2D, e), Array.isArray(t)) {
        ...
        for (let d = 0; d < t.length; d++) {
          l === 4 && s.pixelStorei(n.UNPACK_ALIGNMENT, 1);
          const u = t[d];
          u === null || ArrayBuffer.isView(u) ? s.texImage2D(n.TEXTURE_2D, d, r, l, c, 0, r, n.UNSIGNED_BYTE, u) : s.texImage2D(n.TEXTURE_2D, d, r, r, n.UNSIGNED_BYTE, u), l = Math.max(l >> 1, 1), c = Math.max(c >> 1, 1)
        }
        a = !1
      } else t === null || ArrayBuffer.isView(t) ? s.texImage2D(n.TEXTURE_2D, 0, r, i, o, 0, r, n.UNSIGNED_BYTE, t) : s.texImage2D(n.TEXTURE_2D, 0, r, r, n.UNSIGNED_BYTE, t);
      a && s.generateMipmap(n.TEXTURE_2D), s.bindTexture(n.TEXTURE_2D, null)
    }
    return e
  }, a.prototype.deleteTexture2D = function(e) {
    let t;
    a.removeFromArray(e, this.textures), (t = this.gl()) === null || void 0 === t || t.deleteTexture(e)
    ...
    let t;
    a.removeFromArray(e, this.buffers), (t = this.gl()) === null || void 0 === t || t.deleteBuffer(e)
    ...
    let t;
    a.removeFromArray(e, this.framebuffers), (t = this.gl()) === null || void 0 === t || t.deleteFramebuffer(e)
    ...
    if (e) {
      e.flush(), e.finish();
      let t, n, i = this.textures.length;
    ...
    a = {
      ...
      useGLparticlesInner: function() {
        const e = this,
          ...
          s = function() {
            const t = e.runParticlesTest();
            return i.put("webGLtest3", {
              status: t,
              ua: a
            }), t === e.retOk
          };
        return o.platform === "desktop" && W.target !== "embed2" && (!t && (r && r.ua === a ? r.status === this.retOk : s()))
      },
      ...
      renderParticleUpdateTest: function(e, t, n, i) {
        ...
        if (o.bindFramebuffer(this.it.framebuffer, this.it.texture1), a) {
          ...
          const s = this.it.shEncodeDecode;
  ...
  const t = function e(t, n, i, o) {
    const r = t instanceof e;
  ...
  const i = n.ImageGraph,
    ...
    a = function(e) {
      ...
      return e && (t.__proto__ = e), t.prototype = Object.create(e && e.prototype), t.prototype.constructor = t, t.prototype.render = function(e, t) {
        ...
        for (r.beginPath(), r.moveTo(d[1][0], c), r.lineTo(d[1][0], d[1][1]), i = 0; i < a + 1; ++i) {
          const m = this.getControlPoint(d[i], d[i + 1], d[i + 2]),
    ...
    s = function(e) {
      ...
      return e && (t.__proto__ = e), t.prototype = Object.create(e && e.prototype), t.prototype.constructor = t, t.prototype.findMinMax = function(e) {
        let t = Math.min.apply(Math, e),
          n = Math.max.apply(Math, e);
        t -= 1;
        let i = (n = (t -= Math.round(.05 * (n - t))) + Math.round(n - t)) - t;
    ...
    l = function(e) {
      ...
      return e && (t.__proto__ = e), t.prototype = Object.create(e && e.prototype), t.prototype.constructor = t, t.prototype.render = function(e) {
        for (let t = e.isDay, n = 0; n < t.length; n++) {
          const i = t[n],
            o = n * this.tdWidth,
            r = (n + 1) * this.tdWidth,
            a = o + Math.abs(i) * this.tdWidth;
          this.ctx.fillStyle = this.nightColor, i === 1 ? this.ctx.clearRect(o, 0, r, this.h) : i === 0 ? this.ctx.fillRect(o, 0, r, this.h) : i < 0 ? (this.ctx.clearRect(o, 0, a, this.h), this.ctx.fillRect(a, 0, r, this.h)) : (this.ctx.fillRect(o, 0, a, this.h), this.ctx.clearRect(a, 0, r, this.h))
        }
        return this
      }, t
    }(o);
  ...
  const o = i.extend({
    ...
    ident: null,
    key: function(e) {
      return typeof e == "string" ? e : e.id ? e.id : e.key ? e.key : e.type === "station" ? e.id : e.type === "webcam" ? String(e.webcamId) : e.type === "airport" && e.icao || e.icao ? e.icao : `${n.normalizeLatLon(e.lat)  }/${  n.normalizeLatLon(e.lon)}`
    },
    ...
    dedupeFav: function(e, t) {
      if (typeof e == "string" && this.data[e]) return this.data[e];
      if (typeof e == "object") {
        if (e.type === "station") return t((function(t) {
          return t.stationId === (e.stationId || e.id)
        }));
        if (e.type === "webcam") return t((function(t) {
          return t.webcamId === e.webcamId
        }));
        if (e.type === "airport" || e.icao) return t((function(t) {
        ...
        if (n.isValidLatLonObj(e)) {
          return t((function(t) {
            ...
            return n.isNear(e, t) && t.type === "fav"
          }))
        }
      }
    },
    ...
    sortFavs: function(e, t, n) {
      ...
      return n && (i = i.filter((function(e) {
        ...
        return ((o = a[n][t]) !== null && void 0 !== o ? o : 0) - ((r = a[e][t]) !== null && void 0 !== r ? r : 0)
      }))
    },
  ...
  const d = L.GridLayer.extend({
    ...
    createTilesUrl: function() {
      const e = s.get("englishLabels") ? "en" : s.get("usedLang");
    ...
    updateProduct: function(e) {
      ...
      const i = t[n].refTime.call(t[n]);
      if ((this.product !== n || this.refTime !== i) && (this.product = n, this.refTime = i, e))
        for (const o in this.cityDivs) this.loadFcstTile(this.cityDivs[o])
    },
    ...
    toArray: function() {
      let e = [];
      for (const t in this.cityDivs) e = e.concat(this.cityDivs[t].labels);
      return e
    },
    refreshWeather: function() {
      for (const e in this.cityDivs)
        for (let t = this.cityDivs[e].labels, n = 0; n < t.length; n++) this.renderWeather(t[n])
    },
    ...
    renderTile: function(e, t, n) {
      for (var i = this._getTilePos(t), o = i.x, a = i.y, s = this._map.getPixelOrigin(), l = s.x, c = s.y, d = 256 << t.z, u = [], h = 0; h < n.length; ++h) {
        ...
        A.dataset.id = S, A.dataset.poi = "label", A.className = v, A.style.transform = `translate(${  _  }px, ${  E  }px)`, A.style.width = `${y  }px`, T || u.push({
          id: S,
          el: A
        }), e.appendChild(A)
      }
    ...
    getIndexToCityTileData: function() {
      let e, n, i = s.get("product"),
        o = (e = t[i]) === null || void 0 === e || (n = e.calendar) === null || void 0 === n ? void 0 : n.timestamps;
      if (!o) return null;
      for (let r = 0, a = o.length - 1; r <= a;) {
    ...
    renderWeather: function(e) {
      ...
      if (t)
        if (n && n.length) {
          const i = this.getIndexToCityTileData();
          i && i >= 0 && i < n.length ? t.dataset.temp = `${a.temp.convertNumber.call(a.temp.m, n[i])  }°` : t.removeAttribute("data-temp")
    ...
    createImageTile: function(e, t) {
      ...
      return r.onload = function() {
        ...
        if (s && i) {
          ...
          const l = i.getImageData(0, 0, e, e),
  ...
  let p = 0,
    f = a.get("startUp"),
    m = c.sharedCoords || (f === "location" ? a.get("homeLocation") || {
      lat: 50,
      lon: 14
    } : f === "last" ? a.get("startUpLastPosition") : l.getMyLatestPos()),
  ...
  function T(e, t) {
    void 0 === t && (t = !1);
    const n = e.zoom ? r.bound(e.zoom, 3, 20) : w.getZoom();
    if (e.paddingLeft || e.paddingTop) {
      const i = e.paddingLeft || 0,
        o = e.paddingTop || 0,
  ...
  "source" in m && m.source === "fallback" && s.once("newLocation", (function(e) {
    e.zoom = 5, T(e, !0)
  }));
  let S, _, E, A = null;
  ...
  C(), M(), P(a.get("graticule")), w.on("moveend", C), w.on("movestart", (function() {
    ...
    let t;
    e && !E ? (t = (E = new d(`${o.tileServer  }/tiles/v9.0/grayland/{z}/{x}/{y}.png`, {
      minZoom: 3,
      maxZoom: 11,
      updateWhenIdle: !!o.isMobileOrTablet,
      updateWhenZooming: !1,
      keepBuffer: o.isMobileOrTablet ? 1 : 4
    }).addTo(w)) == null ? void 0 : E.getContainer()) === null || void 0 === t || t.classList.add("land-mask-layer") : !e && E && (w.removeLayer(E), E = null)
  })), a.on("usedLang", O), a.on("country", O), e.baseLayer = S, e.centerMap = T, e.ensurePointVisibleX = function(e, t, n) {
    const i = w.latLngToContainerPoint([e, t]).x;
    i < n && w.panBy([i - n, 0])
  }, e.ensurePointVisibleY = function(e, t, n) {
    const i = w.latLngToContainerPoint([e, t]).y,
      o = w.getSize();
...
function() {
  ...
  const e = function(e) {
      let t;
      ((t = window.W.lib) === null || void 0 === t ? void 0 : t.verbose) && console.log(`Initializing Windy API: ${  e}`)
    },
    t = function(e) {
      throw new Error(`Windy API error: ${  e}`)
    };
  e("Checking Leaflet library"), window.L || t("Leaflet is missing. Add Leaflet to the HTML head tag."), /^1\.9/.test(window.L.version) || t("Wrong version of Leaflet library. Version 1.4.x is required");
  var n, i = function(n, o) {
    let r;
    if ((r = window.W.lib) === null || void 0 === r ? void 0 : r.initialized) {
      for (const a in W) delete W[a];
    ...
    const l = window.W.require;
    l("http").post("https://api.windy.com/api/map-forecast/v2/auth", {
      data: { key: n.key, hostname: 'https://test.buntarcopilot.com/' },
    }).then((function(i) {
      let r, a, s = i.data;
      window.W.lib = {
        verbose: n.verbose || !1,
        initialized: (a = (r = window.W.lib) === null || void 0 === r ? void 0 : r.initialized) !== null && void 0 !== a && a,
        get initAuth() {
          return s.auth
        }
      };
      ...
      h.innerHTML = c.replace("__APIUSER__", s.apiUser), h.classList.add(s.paid ? "paid-model" : "free-model"), document.body.classList.add("target-lib"), e("Adding start-up options"),
        function(t, n, i) {
          let o, r = t("rootScope"),
            ...
            s = t("store");
          if (n.expertMode = (o = n == null ? void 0 : n.expertMode) !== null && void 0 !== o && o, i.paid) {
            let l, c;
            e("key type: paid");
            let d, u = ["capAlerts", "radar", "map", "nems", "bomAccess", "mblue", "airQ", "radarSat", "intersucho"],
              h = function(e, t) {
                return e.filter((function(e) {
                  return t.indexOf(e) === -1
                }))
              };
            ((l = i.features) === null || void 0 === l ? void 0 : l.intersucho) ? e("intersucho is enabled"): u.push("awr_0_40", "awr_0_100", "awp_0_40", "awp_0_100", "awd_0_40", "awd_0_100", "intersuchoAWD", "intersuchoAWP", "intersuchoAWR"), ((c = i.features) === null || void 0 === c ? void 0 : c.ecmwf) ? e("ECMWF is enabled") : (u.push("ecmwf", "ecmwfWaves", "thunder", "cloudtop", "cbase", "visibility", "sst", "efi", "efiTemp", "efiRain", "efiWind"), s.setDefault("product", (d = n.product) !== null && void 0 !== d ? d : "gfs"), s.setDefault("prefferedProduct", n.product === "icon" ? "icon" : "gfs"), r.isolines = ["off", "pressure", "gh", "temp"]), r.overlays = h(r.overlays, u), r.localProducts = h(r.localProducts, u), r.globalProducts = h(r.globalProducts, u), r.seaProducts = h(r.seaProducts, u)
          ...
          })), n.favOverlays || (n.favOverlays = [].concat(r.overlays)), a.favOverlays.def = n.favOverlays, e(`Available products: ${  r.products.join(", ")}`), e(`Available overlays: ${  r.overlays.join(", ")}`), (n == null ? void 0 : n.lat) && ((n == null ? void 0 : n.lon) || (n == null ? void 0 : n.lng)) && (s.set("startUp", "location"), s.set("homeLocation", {
            lat: n.lat,
            lon: n.lon || n.lng || 0,
          ...
          u.translateDocument(h), e("Initializing rest of Windy API"),
            function(n, i, o, r) {
              ...
              W.loadOrphanedModules(), p.setZoom(i.zoom || 5, {
                ...
                const e = n("plugins").picker;
                if (e) return e.getParams();
                throw new Error("Picker plugin is not opened")
              };
              let g, w, y = (a = i.overlay) !== null && void 0 !== a ? a : l.get("overlay"),
                b = (g = i.product) !== null && void 0 !== g ? g : l.get("product"),
                T = m.getProduct(y, b);
              if (b !== T) {
              ...
              l.set("product", i.product || l.get("product"), {
                ...
                return l.set("overlay", (w = i.overlay) !== null && void 0 !== w ? w : "wind", {
                  forceChange: !0
                })
              })).then((function() {
                o == null || o({
